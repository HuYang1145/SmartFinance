...
public class HoroscopePanel extends JPanel {
    ...
    private final SpendingHoroscopeService horoscopeService;
    ...
    public HoroscopePanel(String username) {
        ...
        if (username == null || username.trim().isEmpty()) {
            String sessionUser = UserSession.getCurrentUsername();
        ...
        this.horoscopeService = new SpendingHoroscopeService();
