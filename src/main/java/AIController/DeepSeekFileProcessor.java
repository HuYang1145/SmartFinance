...
public class DeepSeekFileProcessor {
     ...
     */
    public static String callDeepSeekApi(String fileContent, String userQuery) throws IOException, InterruptedException, Exception {
        HttpClient client = HttpClient.newHttpClient();

        // 构建发送给API的消息内容
        // 将文件内容和用户问题组合起来作为用户消息的内容
        String combinedContent = "Below is the content of the document:\n\n---\n" + fileContent + "\n---\n\nHere's my question.：" + userQuery;
