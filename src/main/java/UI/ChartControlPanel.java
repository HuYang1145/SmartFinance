...
public class ChartControlPanel extends JPanel {
    ...
    private IncomeExpenseChart incomeExpenseChart;
    ...
    public void setChartPanel(JPanel chartPanel) {
        this.incomeExpenseChart = null; // We'll update directly
        updateChart();
    }
    ...
    private void updateChart() {
        if (username != null) {
            ...
            JPanel newChartPanel = IncomeExpenseChart.getIncomeExpensePlane(username, yearMonth);
    ...
    public static void showChartWithControls(String username) {
        ...
        JPanel chartPanel = IncomeExpenseChart.getIncomeExpensePlane(username, initialYearMonth);
