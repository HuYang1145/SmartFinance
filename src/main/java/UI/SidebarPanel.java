...
import Person.Deposit;
import Person.Pay;
import Person.TransactionHistory;
import Person.ViewBalance;
import Person.ViewPersonalInfo;
import Person.Withdrawal;
...
public class SidebarPanel extends JPanel {
    ...
    private void initializeButtons() {
        ...
        JButton transferButton = createSidebarButton("Pay", "/UI/icons/transfer_out.png", btnSize);
    ...
    private void configureButtonActions(JButton individualCenterButton, JButton viewBalanceButton,
        ...
        transferButton.addActionListener(e -> parentUI.checkLoginAndShowDialog(() ->
                new Pay(parentUI).setVisible(true)
        ));
