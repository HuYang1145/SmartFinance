...
public class AdminView extends JDialog {
    ...
    public AdminView(Runnable dashboardAction, Runnable adminInfoAction, Consumer<String[]> modifyCustomerAction,
                    Consumer<List<AccountModel>> customerInquiryAction, Consumer<Set<String>> deleteUsersAction,
    ...
    private void setupAccountPanel(Consumer<List<AccountModel>> customerInquiryAction, Consumer<Set<String>> deleteUsersAction) {
    ...
    public void updateAccountTable(List<AccountModel> accounts) {
    ...
    // Inner class: Administrator Information Dialog
    private class AdminInfoDialog extends JDialog {
        public AdminInfoDialog(AdminModel model) {
            ...
            if (loggedInUsername == null || loggedInUsername.isEmpty()) {
                showMessage("Administrator login information not detected, please log in first", "Error", JOptionPane.ERROR_MESSAGE);
                dispose();
                return;
            }

            try {
                String[][] adminInfo = model.getAdminInfo(loggedInUsername);
                ...
                showMessage("Failed to load administrator information: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                dispose();
                return;
            }
    ...
    // Inner class: Modify Customer Information Dialog
    public class ModifyCustomerDialog extends JDialog {
        ...
        public ModifyCustomerDialog(AccountModel account, Consumer<ModifyCustomerDialog> confirmCallback) {
    ...
    // Method: Show administrator information dialog
    public void showAdminInfoDialog(AdminModel model) {
        new AdminInfoDialog(model);
    }

    // Method: Show modify customer information dialog
    public void showModifyCustomerDialog(AccountModel account, Consumer<ModifyCustomerDialog> confirmCallback) {
